...
namespace StringExtensions
{
    ...
    {
        /// <summary>
        /// Crypting inputted string with MD5 algorithm
        ...
        /// <summary>
        /// Check if inputted word
        ///  is one of words in array
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get the first later from the input 
        /// and capitalize it
        /// </summary>
        /// <param name="input"></param>
        /// <returns>inputted string with capitalized first lеtter</returns>
        ...
        /// <summary>
        /// Get part of the string from starting position
        /// to end position
        /// </summary>
        /// <param name="input"></param>
        ...
        /// <returns>substring from originaly inputted string
        /// pr empty string if no such start and end position</returns>
        ...
        /// </summary>
        /// <param name="input"></param>
        /// <returns>Latin username</returns>
        ...
        /// </summary>
        /// <param name="input"></param>
        /// <returns>Latin filename</returns>
        ...
        /// <summary>
        /// Check if the fileExtension is a valid type
        /// </summary>
        /// <param name="fileExtension"></param>
        /// <returns>contet type</returns>
